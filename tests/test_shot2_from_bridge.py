#!/usr/bin/env python3
"""
Stage 2 Only: Shot 2 I2V from Bridge Frame
Uses already-generated bridge_frame_ayush_00001_.png
"""
...
BRIDGE_FRAME = "bridge_frame_ayush_00001_.png"
...
print(f"\n{'='*60}")
print(f"SHOT 2 I2V FROM BRIDGE FRAME: {BRIDGE_FRAME}")
print(f"{'='*60}\n")
    ...
    try:
        ...
        if prompt_id in history:
            ...
            if outputs:
                ...
                print(f"  Shot 2: shot2_from_bridge_00001.mp4")
                exit(0)
